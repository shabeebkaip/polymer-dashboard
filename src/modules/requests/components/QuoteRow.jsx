...
// import { patchQuoteRequestApi } from "../api";
...
// const QuoteRow = ({ isLastRow, quote, index, getResponseBack }) => {
...
//   useEffect(() => {
//     setLocalStatus(quote?.status?.toLowerCase() === "approved");
//   }, [quote?.status]);
...
//     try {
//       const res = await patchQuoteRequestApi(id, payload);
//       if (res?.success) {
//         enqueueSnackbar(`Quote ${payload.status} successfully.`, {
//           variant: "success",
...
//         }
//       } else {
//         enqueueSnackbar(res?.message || "Failed to update quote status.", {
//           variant: "error",
//           anchorOrigin: { vertical: "top", horizontal: "right" },
//         });
//       }
