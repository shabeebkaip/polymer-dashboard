...
import { DollarSign, User, Building2, Package } from "lucide-react";
...
const FinanceModal = () => {
  ...
  const statusStyle = getStatusColor(finance?.status);
          ...
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} md={8}>
              <Box display="flex" alignItems="center" gap={2} mb={1}>
                ...
                >
                  {finance?.productId?.productName || "N/A"}
                </Typography>
              </Box>
            ...
            <Grid item xs={12} md={4}>
              <Box textAlign="right">
                <Chip
                  label={finance?.status?.toUpperCase() || "UNKNOWN"}
                  sx={{
                ...
                >
                  Request ID: {finance?._id?.slice(-8) || "N/A"}
                </Typography>
              </Box>
            </Grid>
          </Grid>
                ...
                <Box sx={{ display: "grid", gap: 1.5 }}>
                  ...
                  <Box>
                    ...
                    <Typography
                      ...
                      sx={{ color: "#1F2937", fontSize: "0.875rem" }}
                    >
                      {finance?.quantity?.toLocaleString() || "N/A"}
                    </Typography>
                  </Box>
                  <Box>
                    <Typography
                    ...
                    >
                      {finance?.estimatedPrice
                        ? `$${finance.estimatedPrice.toLocaleString()}`
                        : "N/A"}
                    </Typography>
                  </Box>
                </Box>
              ...
              >
                ...
                <Box sx={{ display: "grid", gap: 1.5 }}>
                  ...
                  <Box>
                    ...
                    >
                      {finance?.estimatedPrice && finance?.emiMonths
                        ? `$${(
                            finance.estimatedPrice / finance.emiMonths
